...
#import "CJProgressDelegate.h"

@interface CJNetworkQueue : NSOperationQueue <CJProgressDelegate, CJHTTPRequestDelegate, NSCopying> {
...
// All CJNetworkQueues are paused when created so that total size can be calculated before the queue starts
