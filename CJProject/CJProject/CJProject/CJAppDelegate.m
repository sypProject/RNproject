...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.timer = [CJTimer timerWithTimeInterval:1 protocol:self userInfo:nil repeats:YES];
    [self.timer start];
    

    
    CJException *exception = [CJException defaultException];
    NSInteger a = 12;
    NSString *b = [[NSString alloc] init];
    b = [NSString stringWithFormat:@"%d",a];
    [b release];
    b= @"123";
    //[exception release];
